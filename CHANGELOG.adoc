...
Current published release is:
 ...
 libraryDependencies += "fi.e257" %%% "tackler-api"  % "0.30.0"
 libraryDependencies += "fi.e257" %%  "tackler-core" % "0.30.0"
...
* Reject "identity" (e.g. `1 € @ 2 €` and `1 € = 2 €`) value positions as invalid construct
