...
Currently published releases are:
 ...
 libraryDependencies += "fi.e257" %%% "tackler-api"  % "0.35.0"
 libraryDependencies += "fi.e257" %%  "tackler-core" % "0.35.0"


== Release history

=== Tackler release 2022-12

[cols="1,2",width=50%]
|===
|Component | Version

|Tackler CLI  | 22.12.0-SNAPSHOT
|tackler-core | 1.0.0-SNAPSHOT
|tackler-api  | 1.0.0-SNAPSHOT
|===
