...
Current published release is:
 ...
 libraryDependencies += "fi.e257" %%% "tackler-api"  % "0.23.0"
 libraryDependencies += "fi.e257" %%  "tackler-core" % "0.23.0"
 ...
 * Support for Journal format versions v1 and v2
 ** See xref:./docs/tep/tep-1009.adoc[TEP-1009: Txn Header Syntax]
 * Support numerical sub-account names
 ** See xref:./docs/tep/tep-1008.adoc[TEP-1008: Numerical Account names] for details
 ** And related Gitlab link:https://gitlab.com/e257/accounting/tackler/issues/2[Issue: 2]
 * All user documentation is moved to Tackler's new web site: https://tackler.e257.fi/
...
This release has Phase 1 support for journal version v2.  This means that it accepts
journal format v1, but output will be only in format v2.
