 ...
 * Support numerical sub-account names, see:
 ** xref:./docs/tep/tep-1008.adoc[TEP-1008: Numerical Account names]
 ** link:https://gitlab.com/e257/accounting/tackler/issues/2[GitLab Issue: 2]
