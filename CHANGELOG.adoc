...
Current published release is:
 ...
 libraryDependencies += "fi.e257" %%% "tackler-api"  % "0.22.0"
 libraryDependencies += "fi.e257" %%  "tackler-core" % "0.22.0"
 ...
 ** link:./docs/auditing.adoc[Accounting Auditing and Asssurance]
 ** link:./docs/tep/tep-1007.adoc[TEP-1007: Txn Set Checksum]
 ** link:./docs/tackler.conf[tackler.conf]
 * New or changed MetadataItems:
 ** New item: `TxnSetChecksum`
 ** New item: `AccountSelectorChecksum`
 ** New fields: `GitInputReference`
...
** link:./docs/tackler.conf[tackler.conf]
** link:./docs/tep/tep-1006.adoc[TEP-1006: Configuration settings for report output scale]
