...
There are provided configuration files for xref:./tackler-conf.adoc[tackler.conf]
and example of xref:./accounts-conf.adoc[accounts.conf] included in documentation folder.
...
in xref:./tackler-conf.adoc[tackler.conf] by 'CLI:' notation.
