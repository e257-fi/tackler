...
This means that it will accept both old deprecated xref:/docs/journal/format/v1.adoc[version v1]
and new xref:/docs/journal/format/v2.adoc[version v2] of journal format. All exports
(xref:/docs/export-equity.adoc[Equity] and xref:/docs/export-identity.adoc[Identity])
are in new format.
