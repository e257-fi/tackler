 ...
 ** xref:/docs/journal/format/v2.adoc[New Journal Format v2]
 ** xref:/docs/journal/format/v1.adoc[Deprecated Journal Format v1]
 ** Background: {gitlink}/docs/tep/tep-1009.adoc[TEP-1009: Txn Header Syntax]
 * Support for numerical sub-account names, see:
 ** xref:/docs/journal/format/v2.adoc[Journal Format v2]
